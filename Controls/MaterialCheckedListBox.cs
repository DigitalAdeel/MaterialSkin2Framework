namespace MaterialSkin2Framework.Controls
{
    ...
    public class MaterialCheckedListBox : Panel, IMaterialControl
    {
        ...
        public class ItemsList : List<MaterialSkin2Framework.Controls.MaterialCheckbox>
        {
            ...
            {
                MaterialSkin2Framework.Controls.MaterialCheckbox cb = new MaterialSkin2Framework.Controls.MaterialCheckbox();
                Add(cb);
                cb.Checked = defaultValue;
                cb.Text = text;
            }

            public new void Add(MaterialSkin2Framework.Controls.MaterialCheckbox value)
            {
                base.Add(value);
            ...
            public new void Remove(MaterialSkin2Framework.Controls.MaterialCheckbox value)
            {
                base.Remove(value);
